    ...
    <div className="admin-layout">
      <aside className={`admin-sidebar ${colapsado ? 'collapsed' : ''}`}>
        ...
        <nav className="admin-sidebar-menu">
          ...
          <NavLink to="/professor/turmas" className={({ isActive }) => `admin-menu-item ${isActive ? 'active' : ''}`} data-tooltip="Minhas Turmas">
          ...
          <NavLink to="/professor/ava" className={({ isActive }) => `admin-menu-item ${isActive ? 'active' : ''}`} data-tooltip="AVA">
            <IconBooks size={20} aria-hidden="true" />
            <span>AVA</span>
          </NavLink>
          
          <NavLink to="/professor/relatorios" className={({ isActive }) => `admin-menu-item ${isActive ? 'active' : ''}`} data-tooltip="Relatórios">
